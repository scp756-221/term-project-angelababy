...
class Music():
    """Python API for the music service(s2).
    ...
    ----------
    url: string
        The URL for accessing the music service.
    auth: string
    ...
    def create(self, artist, song):
        ...
        -------
        (number, string)
            The number is the HTTP status code returned by s2.
    ...
    def read(self, m_id):
        ...
        status: number
            The HTTP status code returned by s2.
